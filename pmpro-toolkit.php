...
function pmprodev_admin_menu() {
	add_options_page( __( 'PMPro Toolkit Settings', 'pmpro-toolkit' ), __( 'PMPro Toolkit', 'pmpro-toolkit' ), apply_filters( 'pmpro_edit_member_capability', 'manage_options' ), 'pmprodev', 'pmprodev_settings_page' );
	add_management_page( 'PMPro Toolkit Scripts', __( 'PMPro Toolkit Scripts', 'pmpro-toolkit' ), 'manage_options', 'pmprodev-database-scripts', 'pmprodev_database_scripts_page' );
}
